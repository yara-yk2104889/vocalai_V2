...
> = {
  cafe: [
    ...
    { src: "/samples/cafe/cookies.png", label: "Cookies", arLabel: "بسكويت" },
  ],
  playground: [
...
export default function QatarAACProbePrototype() {
  ...
  // const [speakLoading, setSpeakLoading] = useState(false); // OpenAI TTS — disabled
  // const audioRef = useRef<HTMLAudioElement | null>(null);  // OpenAI TTS — disabled
...
const context = useMemo(
  ...
  // --- OpenAI TTS (disabled — re-enable by swapping with the browser implementation below) ---
